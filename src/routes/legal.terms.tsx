...
export const Route = createFileRoute("/legal/terms")({
  head: () => pageHead({
    path: "/legal/terms",
    title: "Terms of Service \u2014 Crush Chat",
    description: "The Crush Chat Terms of Service: eligibility (18+), account rules, coins and memberships, creator obligations, payments, liability and dispute resolution.",
    type: "article",
  }),
  component: Terms,
});
...
function Terms() {
  return (
    <LegalDoc
      ...
      subtitle={`These Terms are a binding agreement between you and ${LEGAL.entity} ("Crush", "we", "us") covering your use of ${LEGAL.siteLabel} and the Crush apps.`}
    >
