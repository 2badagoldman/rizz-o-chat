...
export const DEMO_HOSTS: DemoHost[] = [
  {
    ...
    bio: "Ex-cheerleader turned café owner. I love long convos, indie films, and people who can actually text back. Come say hi.",
  ...
  },
  {
    ...
    bio: "Founding host on Crush. I'm here to actually reply — tell me about your week and I'll roast your dating life (gently).",
