/**
 * RevenueCat public SDK keys for the Crush project.
 *
 ...
 */
export const REVENUECAT_IOS_PUBLIC_KEY = 'appl_KSlzSVItgkcgBbKSACBQBFAqUKe';
export const REVENUECAT_ANDROID_PUBLIC_KEY = 'goog_KQIDovLGLGecihCAnJGFIZXRfqS';
